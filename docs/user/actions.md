...
| `window-focus-first` / `window-focus-last` | Move focus to the first window in the workspace or the last. |
...
| `column-move-to-first` / `column-move-to-last` | Move the focused window to the beginning of the workspace or the end.
